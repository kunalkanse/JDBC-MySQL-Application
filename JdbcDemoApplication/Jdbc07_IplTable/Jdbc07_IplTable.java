package JdbcDemoApplication.Jdbc07_IplTable;

import java.sql.*;
import java.util.Scanner;

public class Jdbc07_IplTable {
    ...
    private static void question1(){
        String s1="select * from ipl2023 order by win desc, nrr desc";
    ...
    private static void question2(){
        String s1="select t1.team as TeamName,t2.team as TeamName , t2.win as TeamWins from ipl2023 t1 inner join ipl t2 on t1.win=t2.win and t1.pos>t2.pos";
    ...
    private static void question3(){
        String s1="select team as TeamName from ipl2023 order by win desc,nrr desc limit 4";
    ...
    private static void question4(){
        try {
            st.executeUpdate(  "update ipl2023 set nrr = round((0.15 * nrr) + nrr, 4) where pos = (select pos from (select pos from ipl where win = (SELECT ROUND(AVG(win), 0) FROM ipl) ORDER BY nrr LIMIT 1) AS subquery)");
    ...
    private static void question5(){
        try {
            st.executeUpdate("delete from ipl2023 where pos not in (select pos from (select pos from ipl order by win desc,nrr desc limit 4 )as subquery)");
